# JSON Converter Swing

## Projektbeschreibung
JSON Converter Swing ist eine Java-Anwendung, die Benutzereingaben in JSON-Format umwandelt. Mit einer intuitiven grafischen Benutzeroberfläche (Swing) können Nutzer ihre Daten einfach eingeben und JSON-Daten generieren, validieren und exportieren.
...
## Kontakt
Bei Fragen oder Anmerkungen wenden Sie sich bitte an [Flo1632](https://github.com/Flo1632).
